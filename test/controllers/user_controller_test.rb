...
class UserControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should return error response when invalid password is given' do
    post '/api/v1/user/register',
         params: { username: 'testing', password: 'te', password_confirmation: 'te', email: 'testing@123.com' }, as: :json
  ...
  test 'should return error response when invalid username and password is given' do
    post '/api/v1/user/register',
         params: { username: 'te', password: 'te', password_confirmation: 'te', email: 'testing@123.com' }, as: :json
  ...
  test 'should return error response when invalid username is given' do
    post '/api/v1/user/register',
         params: { username: 'te', password: 'testing', password_confirmation: 'testing', email: 'testing@123.com' }, as: :json
  ...
  test 'should return error response when invalid email is given' do
    post '/api/v1/user/register',
         params: { username: 'testing', password: 'testing', password_confirmation: 'testing', email: 'testing' }, as: :json
  ...
  test 'should return error response when the different password and confirmed password is given' do
    post '/api/v1/user/register',
         params: { username: 'testing123', password: 'testing123', password_confirmation: 'testing', email: 'testing123@example.com' }, as: :json
  ...
  test 'should return success response when valid data is given' do
    post '/api/v1/user/register',
         params: { username: 'testing123', password: 'testing123', password_confirmation: 'testing123', email: 'testing123@example.com' }, as: :json
  ...
  test 'should return user object and token when valid data is given' do
    post '/api/v1/user/register',
         params: { username: 'testing123', password: 'testing123', email: 'testing123@example.com' }, as: :json

    assert_response :success
    assert_equal 200, status

    post '/api/v1/user/login', params: { username: 'testing123', password: 'testing123' }, as: :json
  ...
  test 'should return error object when valid data is given' do
    post '/api/v1/user/login', params: { username: 'testing12', password: 'testing123' }, as: :json
  ...
  test 'should return user object when valid token is given by headers' do
    ...
    get '/api/v1/user/auto_login', headers: { 'Authorization' => "Bearer #{token}" }
